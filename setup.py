...
setup(
  name = 'Vec',         # How you named your package folder (MyLib)
  packages = ['Vec'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/shachy/Vec/archive/0.1.zip',    # I explain this later on
